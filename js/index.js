  ...
  events: {
    e: {
      ...
      target: {
        selector: '.open-bl',
        originalId:
          '6135a413673b4e62aa9dfd42|12ad282f-6545-fd07-1983-9aec6c1f8c24',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-3': {
      ...
      target: {
        selector: '.main',
        originalId:
          '6135a413673b4e62aa9dfd42|59413532-2c00-add1-4a59-404c23828b8f',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-4': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.scroll-anim--slide-up',
        originalId:
          '6135a413673b4e62aa9dfd42|09027ce0-8a6b-02be-c589-1fe034e9ada0',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-6': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.scroll-anim--fade-in',
        originalId:
          '6135a413673b4e62aa9dfd42|94479017-0ece-4672-36c0-a0068a24775f',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-8': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.footer__form-inputs',
        originalId:
          '6135a413673b4e62aa9dfd42|5ff1b634-246c-ea5d-965e-98a34f37b16c',
        appliesTo: 'CLASS',
      },
      targets: [
        {
      ...
      createdOn: 1629742713761,
    },
  },
  actionLists: {
    a: {
      id: 'a',
      title: 'leadership-open-bl',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.leadership__bl-about',
                  selectorGuids: ['c0f7a5da-fcd4-f902-5054-e45b891701b2'],
                },
                heightValue: 0,
                widthUnit: 'PX',
                heightUnit: 'px',
      ...
      createdOn: 1629478162432,
    },
    'a-2': {
      id: 'a-2',
      title: 'leadership-close-bl',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: '.bubble-main',
                      selectorGuids: ['24887fa7-ff32-3d04-d8a2-b2c1faa58f07'],
                    },
                    xValue: -10,
                    xUnit: '%',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.bubble-top',
                      selectorGuids: ['2f0a1dd0-5d95-f43b-4f19-a54e1f1e834e'],
                    },
                    xValue: -16,
                    xUnit: '%',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.bubble-left',
                      selectorGuids: ['41cc1642-c318-8280-a194-39649a231b22'],
                    },
                    xValue: -30,
                    xUnit: '%',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.bubble',
                      selectorGuids: ['d157fe00-3058-225e-78ce-580521e92b55'],
                    },
                    xValue: 15,
                    xUnit: '%',
                    yUnit: 'PX',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib2',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    'a185f423-064c-0f32-87ad-01151624e1d0',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib1',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    '5165ebb9-367d-1bfa-73e1-ab5c1f9c2801',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib3',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    '684b8fd9-5c43-1ffc-674c-c77f414794da',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib4',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    'd2e1cf58-8866-43ae-3c47-757100ce8e6e',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib5',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    'bb0d71ea-8395-21c3-f5ef-f778a62a197b',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.input-border.ib6',
                  selectorGuids: [
                    'da646fee-8997-c30c-9e60-57e4bab45709',
                    '30bf8d25-d717-7885-5bec-22ec3336971b',
                  ],
                },
                widthValue: 0,
                widthUnit: '%',
